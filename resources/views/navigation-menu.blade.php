<nav x-data="{ open: false }" class="bg-lol-dark border-b" style="border-color: #0A1428;">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('arguments') }}" :active="request()->routeIs('arguments')">
                        {{ __('Arguments') }}
                    </x-nav-link>
                </div>
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('champions') }}" :active="request()->routeIs('champions')">
                        {{ __('Champions') }}
                    </x-nav-link>
                </div> --}}
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
