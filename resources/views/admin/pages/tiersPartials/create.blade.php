...
@section('content')
    <div class="container-fluid">
        <div class="card w-75 m-auto shadow-lg">
            ...
            <div class="card-body">
              <form class="row" method="post" id="FormData" action="{{ route('tierSave') }}">
                @csrf
                <input type="hidden" name="real_name" id="real_name">
                <input type="hidden" name="champion" id="champion">
                ...
                <div class="mb-3 p-3 rounded selected-champions bg-lol">
                    <div class="text-center">
                        ...
                        <div class="styleName">
                            ...
                            <span class="styleText text-white" id="defaultFirst">Elige un Campeón</span>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
