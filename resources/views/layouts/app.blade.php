...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @if (isset($title))
            <title>{{$title}}</title>
        @else
            <title>ArenaLol Tier List</title>
        @endif
